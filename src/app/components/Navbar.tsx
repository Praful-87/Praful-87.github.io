  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        >
          <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-slate-700 via-slate-800 to-slate-600 flex items-center justify-center font-bold text-white text-sm tracking-wider border border-white/20 shadow-inner group-hover:border-sky-400 transition-colors">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className={`hidden sm:inline-flex items-center gap-2 px-4 py-2 text-xs font-semibold uppercase tracking-wider rounded-full transition-all duration-200 ${
              isDark
                ? 'text-white bg-white/[0.06] hover:bg-white/[0.12] border border-white/10'
          ...
          <button
            ...
            className={`p-2.5 rounded-full transition-colors cursor-pointer border ${
              isDark
                ? 'text-slate-400 hover:text-white hover:bg-white/[0.06] border-transparent hover:border-white/10'
          ...
          >
            {isDark ? (
              ...
              <FiMail className="w-4 h-4 text-indigo-600 transition-transform hover:-rotate-12" />
            )}
          </button>
