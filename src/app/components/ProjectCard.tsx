...
import { Github, ExternalLink, Sun, Check, Zap } from 'lucide-react';
...
export const ProjectCard: React.FC<ProjectCardProps> = ({ project, onSelect, isDark }) => {
  // Render custom graphical mockup preview header based on project type
  const renderPreviewHeader = () => {
    switch (project.previewType) {
      case 'task-board':
        return (
          <div className="h-48 bg-gradient-to-br from-slate-900 via-[#131c31] to-[#0a0d14] relative p-3 flex flex-col justify-between border-b border-white/[0.08] overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-tr from-sky-500/10 via-transparent to-indigo-500/10 opacity-60 group-hover:opacity-100 transition-opacity" />
            ...
            <div className="relative flex items-center justify-between z-10">
              <div className="flex items-center gap-1.5">
                ...
                <span className="ml-2 text-[10px] font-mono text-slate-400/80">{project.filename}</span>
              </div>
              <div className="flex items-center gap-1.5">
                {project.isFeatured && (
            ...
            <div className="relative z-10 grid grid-cols-3 gap-2 mt-2 px-1">
              ...
              <div className="bg-slate-900/90 rounded-lg p-2 border border-white/5 space-y-1.5">
                <div className="flex items-center justify-between">
                  <span className="text-[9px] font-semibold text-slate-400 uppercase">Todo</span>
                  <span className="text-[9px] px-1 rounded bg-slate-800 text-slate-400">3</span>
                </div>
              ...
              <div className="bg-slate-900/90 rounded-lg p-2 border border-white/5 space-y-1.5">
                <div className="flex items-center justify-between">
                  <span className="text-[9px] font-semibold text-sky-400 uppercase">In Dev</span>
                  <span className="text-[9px] px-1 rounded bg-sky-500/20 text-sky-400">2</span>
                </div>
              ...
              <div className="bg-slate-900/90 rounded-lg p-2 border border-white/5 space-y-1.5">
                <div className="flex items-center justify-between">
                  <span className="text-[9px] font-semibold text-emerald-400 uppercase">Done</span>
                  <span className="text-[9px] px-1 rounded bg-emerald-500/20 text-emerald-400">5</span>
                </div>
      ...
      case 'ecommerce-metrics':
        return (
          <div className="h-48 bg-gradient-to-br from-slate-900 via-[#142323] to-[#0a0d14] relative p-3 flex flex-col justify-between border-b border-white/[0.08] overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-tr from-emerald-500/10 via-transparent to-teal-500/10 opacity-60 group-hover:opacity-100 transition-opacity" />
            ...
            <div className="relative z-10 grid grid-cols-2 gap-2 mt-2 px-1">
              <div className="bg-slate-900/90 rounded-lg p-2.5 border border-white/5 flex flex-col justify-between">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[9px] text-emerald-400 font-semibold">+24.8%</span>
                </div>
                <div className="text-base font-bold text-white mt-1">$142.8k</div>
              ...
              <div className="bg-slate-900/90 rounded-lg p-2.5 border border-white/5 flex flex-col justify-between">
                ...
                <div className="text-[9px] text-slate-400 mt-1">Stripe • Next.js API</div>
              </div>
            </div>
      ...
      case 'portfolio-template':
        return (
          <div className="h-48 bg-gradient-to-br from-slate-900 via-[#181d33] to-[#0a0d14] relative p-3 flex flex-col justify-between border-b border-white/[0.08] overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/10 via-transparent to-indigo-500/10 opacity-60 group-hover:opacity-100 transition-opacity" />
            ...
            <div className="relative z-10 grid grid-cols-3 gap-1.5 mt-2 px-1">
              ...
              <div className="col-span-2 bg-slate-900/90 rounded-lg p-1.5 border border-white/5 flex items-center justify-between px-2">
                ...
                <span className="text-[8px] font-mono text-blue-400">98% Perf</span>
              </div>
            </div>
      ...
      case 'weather-radar':
        return (
          <div className="h-48 bg-gradient-to-br from-slate-900 via-[#102334] to-[#0a0d14] relative p-3 flex flex-col justify-between border-b border-white/[0.08] overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-tr from-sky-500/10 via-transparent to-cyan-500/10 opacity-60 group-hover:opacity-100 transition-opacity" />
  ...
  return (
    <div
      ...
      className={`group relative rounded-2xl border transition-all duration-300 hover:-translate-y-1 flex flex-col overflow-hidden cursor-pointer ${
        isDark
          ? 'bg-[#0f1422] border-white/[0.08] hover:border-sky-400/50 hover:shadow-[0_10px_35px_-10px_rgba(56,189,248,0.2)]'
    ...
    >
      ...
      <div className="p-6 flex-1 flex flex-col justify-between">
        ...
        {/* Action Buttons */}
        <div
          className="flex items-center gap-3 text-xs font-medium border-t border-white/[0.06] pt-4"
