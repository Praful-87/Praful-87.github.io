        ...
        <div className="relative pl-6 md:pl-10 space-y-8">
          ...
          {EXPERIENCES.map((exp, index) => (
            <div key={exp.id} className="relative group">
              ...
              <div className="absolute -left-6.75 md:-left-9.75 top-6 flex items-center justify-center">
                {exp.isCurrent ? (
                  <>
              ...
              <div
                ...
                className={`p-6 md:p-8 rounded-2xl border transition-all duration-300 card-glow ${
                  isDark
                    ? "bg-[#0f1422] border-white/8 hover:border-white/20"
              ...
              >
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center font-bold text-lg group-hover:scale-105 transition-transform shrink-0 ${
                        isDark
